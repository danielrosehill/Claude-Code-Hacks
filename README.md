...
A running notebook of small tricks, workarounds, and hacks for [Claude Code](https://claude.com/claude-code).
...
<!-- Add new hacks here, newest first -->

_No hacks logged yet._
